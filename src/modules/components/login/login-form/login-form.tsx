      ...
      {!isUsernameValid &&
        <form onSubmit={handleSubmit(onUsernameSuccess)}>
          <div className='inline-flex gap-6'>
            <Input {...register('username', { required: true })} isRequired placeholder='Nombre de usuario' size='md' className='min-w-72' />
            <Button isIconOnly type='submit' size='md' style={{ backgroundColor: '#191c1f' }} >
              <svg className='size-3.5' width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21 10.5L12.8571 2M21 10.5L12.8571 19M21 10.5H2" stroke="#F7F7F7" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </Button>
          </div>
        </form>
