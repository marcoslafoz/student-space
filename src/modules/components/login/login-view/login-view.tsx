...
export const LoginView: React.FC = () => {
  ...
  return (
    <>
      <div className='fixed' >
        <div style={{ backgroundImage: `url(${StudentSpaceIcon})` }} className='size-12 mx-7  bg-no-repeat bg-center bg-cover' />
      </div>
      ...
      <div className="flex items-center justify-center min-h-screen gap-40 m-6">
        ...
        <div className='hidden lg:block w-48 h-48 bg-no-repeat bg-center bg-cover' style={{ backgroundImage: `url(${StudentSpaceIcon})` }}></div>
      </div>
