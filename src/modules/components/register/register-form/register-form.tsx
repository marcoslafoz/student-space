...
import { useLazyMutationUserCreate } from '../../../../common/api/apollo/graphql/login'
      ...
      <div className={clsx('grid grid-flow-col auto-cols-auto min-w-96')}>
        ...
        <div>
          ...
          <div className='flex flex-col gap-3 mb-8 '>
            {step === RegisterStepsEnum.NAME &&
              <>
                <p className='font-color-primary text-3xl text-bold max-w-sm'>¿Eres nuevo aquí? <br />Crea tu cuenta ahora</p>
                <p className='text-gray-400 max-w-sm text-sm'>Crea tu cuenta en unos sencillos pasos para unirte a Student Space.</p>
              </>
            }
            {step !== RegisterStepsEnum.NAME &&
              <>
                {name?.trim() != undefined && <p className='font-color-primary text-3xl text-bold max-w-sm'><span>{name}</span>, ayudanos a <br />conocerte mejor</p>}
                {name?.trim() == undefined && <p className='font-color-primary text-3xl text-bold max-w-md'>{name}Ayudanos a conocerte mejor</p>}
            ...
            <div className='flex-row flex justify-between gap-3  '>
              ...
              }
              {
                ...
                (
                  <div className='flex flex-col w-full gap-3' >
                    ...
                    />
                    <DatePicker
                      onChange={e => setValue('birthdate', e && e.toString())}
                      size='sm'
              ...
              }
              {
                ...
                <Button
                  isIconOnly
                  onClick={() => handleSetStep(+1)}
                  isDisabled={username?.trim() === undefined || email?.trim() === undefined || username?.trim() === '' || email?.trim() === ''}
                  size='md'
                  className='z-10'
                  style={{ backgroundColor: '#191c1f' }}
                  data-test-id='login-username-btn'
              ...
              }
              {
                ...
                <Button
                  isIconOnly
                  size='md'
                  isDisabled={password?.trim() === undefined || password?.trim() === '' || repeatPassword?.trim() === undefined || repeatPassword?.trim() === ''}
                  className='z-10'
                  type='submit'
                  style={{ backgroundColor: '#191c1f' }}
                  data-test-id='login-username-btn'
